    ...
    public partial class AddUser : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {                                                            //username,  password, type,email, buildingNumber, name, surname, numberApt,address,City,Country);
                txtErroMsg.Text = ConnectionClass.vnesiKorinik(txtUsername.Text, txtPassword.Text, txtEmail.Text, type, Int32.Parse(BuildingNo), txtIme.Text, txtPrezime.Text, Int32.Parse(txtAptNo.Text), txtAddress.Text, txtCity.Text, txtState.Text);
                Label2.Visible = true;
                txtAddress.Text = "";
                txtAptNo.Text = "";
                txtCity.Text = "";
