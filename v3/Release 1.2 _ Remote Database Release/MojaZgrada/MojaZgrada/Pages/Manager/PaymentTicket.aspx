          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
            ...
            <div class="row">
                <div class="form-group form-inline">
                   ...
                   <asp:TextBox ID="txtPrezime" cssClass="form-control"  runat="server" Enabled="False"></asp:TextBox>
                    <asp:TextBox ID="txtAdresaStan" cssClass="form-control"  runat="server" Enabled="False"></asp:TextBox>
                </div>
                </div>
            <div class="row">
                 <div class="form-group form-inline">
...
&nbsp;<asp:TextBox ID="txtUplata" cssClass="form-control"  runat="server" ></asp:TextBox>
