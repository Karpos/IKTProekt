...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:GridView ID="GridView1"  RowStyle-CssClass="RowStyle"   runat="server" CssClass="table table-bordered table-hover" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Height="222px" Width="890px" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" AllowPaging="True" AllowSorting="True">
        <Columns>
            ...
            <asp:BoundField DataField="attachments" HeaderText="Линк до прикачен документ" SortExpression="date" />
