...
&nbsp;<asp:TextBox ID="Suma" cssClass="form-control"  runat="server" ></asp:TextBox>
...
&nbsp;<asp:TextBox ID="txtBrUplata" cssClass="form-control"  runat="server" MaxLength="16" TextMode="Number" ></asp:TextBox>
         ...
         <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
               <asp:Button ID="btnVnesiUplata" runat="server" Text="Исплати од банка" OnClick="btnVnesiUplata_Click"    />
                </div></div>
        &nbsp;&nbsp;&nbsp;&nbsp;
